...
export default function FrameReport({
  ...
  const cols4 = mapLabels(step4Results);
  const cols5 = mapLabels(step5Results);

  const totalChecks =
    cols1.length + cols2.length + cols3.length + cols4.length + cols5.length;
  const passedChecks = [
    ...cols1,
    ...cols2,
    ...cols3,
...
<Grid item xs={12} md={6}>
  ...
  >
    <Typography variant="h6" fontWeight={600} sx={{ mb: 2, color: '#03a9f4' }}>
      Step 4: Visual / Title / Timing Errors
    </Typography>
    <FormGroup>
      {cols4.map(c => (
        <FormControlLabel
    ...
    {step4Results.comments && (
      <Box sx={{ mt: 2, p: 2, borderRadius: 1, bgcolor: 'rgba(3, 169, 244, 0.05)' }}>
        <Typography variant="caption" color="text.secondary">
          Comments:
        </Typography>
        <Typography variant="body2" sx={{ mt: 0.5 }}>
...
<Grid item xs={12} md={6}>
  ...
  >
    <Typography variant="h6" fontWeight={600} sx={{ mb: 2, color: '#e91e63' }}>
      Step 5: Audio & Glitch Review
    </Typography>
    <FormGroup>
      {cols5.map(c => (
        <FormControlLabel
    ...
    {step5Results.comments && (
      <Box sx={{ mt: 2, p: 2, borderRadius: 1, bgcolor: 'rgba(233, 30, 99, 0.05)' }}>
        <Typography variant="caption" color="text.secondary">
          Comments:
        </Typography>
        <Typography variant="body2" sx={{ mt: 0.5 }}>
          {step5Results.comments}
                ...
                <Divider
                  sx={{ my: 3, borderColor: "rgba(48, 79, 254, 0.2)" }}
                />
                ...
                <TextField
                  ...
                  helperText="This includes your additional final notes"
                  sx={{
                    mb: 3,
